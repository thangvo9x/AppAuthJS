...
export var DefaultTabBar = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function DefaultTabBar(props) {
    ...
    _this.renderTab = function (tab, index, width, onLayoutHandler, styles, theme) {
      ...
      }, renderTab ? renderTab(tab) : /*#__PURE__*/isValidElement(tab.title) ? tab.title : /*#__PURE__*/React.createElement(Text, {
        style: [_extends({
          color: textColor
  ...
  _createClass(DefaultTabBar, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(WithTheme, {
        ...
        }), renderUnderline ? renderUnderline(underlineProps.style) : /*#__PURE__*/React.createElement(Animated.View, _extends({}, underlineProps.style)))));
      });
    }
  }]);

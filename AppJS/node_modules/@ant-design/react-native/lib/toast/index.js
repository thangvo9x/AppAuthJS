...
var defaultProps = (0, _extends2["default"])({}, defaultConfig);
var toastKeyMap = {};
...
function removeAll() {
  Object.keys(toastKeyMap).forEach(function (_key) {
    return _portal["default"].remove(Number.parseInt(_key, 10));
  });
}
...
function notice(content, type) {
  ...
  var props = (0, _extends2["default"])((0, _extends2["default"])({}, defaultProps), {
    content: content,
    type: type,
    duration: duration,
    onClose: onClose,
  ...
  if (typeof content !== 'string') {
    props = (0, _extends2["default"])((0, _extends2["default"])({}, props), content);
  }
  ...
  var key = _portal["default"].add( /*#__PURE__*/_react["default"].createElement(_ToastContainer["default"], {
...
var _default = {
  ...
  getConfig: function getConfig() {
    return (0, _extends2["default"])({}, defaultProps);
  },
  config: function config(props) {
    defaultProps = (0, _extends2["default"])((0, _extends2["default"])({}, defaultProps), props);
  },

...
var InputNumber = /*#__PURE__*/function (_React$Component) {
  ...
  function InputNumber(props) {
    ...
    _this.onFocus = function () {
      ...
      var onFocus = _this.props.onFocus; // tslint:disable-next-line:no-unused-expression
    ...
    _this.onBlur = function (e) {
      ...
      _this.setValue(value, function () {
        var onBlur = _this.props.onBlur; // tslint:disable-next-line:no-unused-expression
    ...
    _this.setValue = function (v, callback) {
      ...
      if (changed) {
        var onChange = _this.props.onChange; // tslint:disable-next-line:no-unused-expression
  ...
  (0, _createClass2["default"])(InputNumber, [{
    ...
    value: function onPressIn(type) {
      ...
      this["".concat(type, "Text")].setNativeProps({
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          upStyle = _this$props3.upStyle,
          downStyle = _this$props3.downStyle,
      ...
      if (state.focused) {
        inputDisplayValue = "".concat(state.inputValue);
      } else {
        inputDisplayValue = "".concat(state.value);
      }
      ...
      return /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
        ...
        accessibilityState: {
          disabled: !editable || !!downDisabledStyle
        }

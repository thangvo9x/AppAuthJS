...
var _AndroidContainer = _interopRequireDefault(require("./AndroidContainer"));
...
var _default = {
  showActionSheetWithOptions: function showActionSheetWithOptions(config, callback) {
    ...
    var key = _portal["default"].add( /*#__PURE__*/_react["default"].createElement(_AndroidContainer["default"], {
      visible: true,

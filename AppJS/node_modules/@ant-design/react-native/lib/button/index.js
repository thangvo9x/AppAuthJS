  ...
  (0, _createClass2["default"])(Button, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_style.WithTheme, {
        ...
        var underlayColor = _reactNative.StyleSheet.flatten(activeStyle ? activeStyle : _styles["".concat(type, "Highlight")]).backgroundColor;

        var indicatorColor = _reactNative.StyleSheet.flatten(_this2.state.pressIn ? _styles["".concat(type, "HighlightText")] : _styles["".concat(type, "RawText")]).color;

        return /*#__PURE__*/_react["default"].createElement(_reactNative.TouchableHighlight, (0, _extends2["default"])({
          activeOpacity: 0.4
        }, restProps, {
          style: wrapperStyle,
          disabled: disabled,

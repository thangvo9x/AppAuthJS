...
var _default = function _default(theme) {
  return _reactNative.StyleSheet.create({
    ...
    ghostDisabledRaw: {
      borderColor: "".concat(theme.color_text_base, "1A") // alpha 10%  https://codepen.io/chriscoyier/pen/XjbzAW
    ...
    primaryHighlightText: {
      color: "".concat(theme.color_text_base_inverse, "4D") // alpha 30%  https://codepen.io/chriscoyier/pen/XjbzAW
    ...
    defaultDisabledRawText: {
      color: "".concat(theme.color_text_base, "4D") // alpha 30%  https://codepen.io/chriscoyier/pen/XjbzAW

    },
    primaryDisabledRawText: {
      color: "".concat(theme.color_text_base_inverse, "99") // alpha 60%  https://codepen.io/chriscoyier/pen/XjbzAW

    },
    ghostDisabledRawText: {
      color: "".concat(theme.color_text_base, "1A") // alpha 10%  https://codepen.io/chriscoyier/pen/XjbzAW

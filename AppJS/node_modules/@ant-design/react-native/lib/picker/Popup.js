...
var _ModalView = _interopRequireDefault(require("../modal/ModalView"));
...
var getModal = function getModal(props, visible, _ref) {
  ...
  var titleEl = typeof title === 'string' ? /*#__PURE__*/_react["default"].createElement(_reactNative.Text, {
    style: [styles.title]
  }, title) : title;
  var okEl = typeof okText === 'string' ? /*#__PURE__*/_react["default"].createElement(_reactNative.Text, {
    style: [styles.actionText, styles.okText]
  }, okText) : okText;
  var dismissEl = typeof dismissText === 'string' ? /*#__PURE__*/_react["default"].createElement(_reactNative.Text, {
    style: [styles.actionText, styles.dismissText]
  }, dismissText) : dismissText;
  return /*#__PURE__*/_react["default"].createElement(_ModalView["default"], {
  ...
  }, dismissEl), /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
    style: [styles.headerItem]
  }, titleEl), /*#__PURE__*/_react["default"].createElement(_reactNative.TouchableHighlight, {
    onPress: onOk,
    style: [styles.headerItem],
    activeOpacity: props.actionTextActiveOpacity,
    underlayColor: props.actionTextUnderlayColor

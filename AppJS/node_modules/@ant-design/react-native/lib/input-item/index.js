...
var InputItem = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2["default"])(InputItem, _React$Component);

  var _super = (0, _createSuper2["default"])(InputItem);
      ...
      switch (type) {
        ...
        case 'phone':
          ...
          if (valueLen > 3 && valueLen < 8) {
            text = "".concat(text.substr(0, 3), " ").concat(text.substr(3));
          } else if (valueLen >= 8) {
            text = "".concat(text.substr(0, 3), " ").concat(text.substr(3, 4), " ").concat(text.substr(7));
          }
  ...
  (0, _createClass2["default"])(InputItem, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_style.WithTheme, {
        ...
        return /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
        ...
        }, children ? typeof children === 'string' ? /*#__PURE__*/_react["default"].createElement(_reactNative.Text, {
          style: [s.text, textStyle]
        }, children) : /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
          style: textStyle
        }, children) : null, /*#__PURE__*/_react["default"].createElement(_Input["default"], (0, _extends2["default"])({
        ...
        })), editable && clear && value && focus && android ? /*#__PURE__*/_react["default"].createElement(_reactNative.TouchableOpacity, {
          style: [s.clear],
          ...
          color: 'white',
          size: 'xxs'
        })) : null, extra ? /*#__PURE__*/_react["default"].createElement(_reactNative.TouchableWithoutFeedback, {
          onPress: onExtraClick
        }, /*#__PURE__*/_react["default"].createElement(_reactNative.View, null, typeof extra === 'string' ? /*#__PURE__*/_react["default"].createElement(_reactNative.Text, {
          style: [s.extra, extraStyle]
        }, extra) : extra)) : null, error && /*#__PURE__*/_react["default"].createElement(_reactNative.TouchableWithoutFeedback, {

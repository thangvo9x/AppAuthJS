...
var _index = _interopRequireDefault(require("../carousel/index"));

var _index2 = _interopRequireDefault(require("../flex/index"));

var _style = require("../style");

var _index3 = _interopRequireDefault(require("./style/index"));
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_style.WithTheme, {
        ...
        var renderItem = _this.props.renderItem || function (dataItem, index) {
          ...
          }, /*#__PURE__*/_react["default"].isValidElement(dataItem.icon) ? dataItem.icon : /*#__PURE__*/_react["default"].createElement(_reactNative.Image, {
            source: {
              uri: dataItem.icon
            },
            style: styles.icon
        ...
        for (var i = 0; i < rowCount; i++) {
          ...
          var _loop = function _loop(j) {
            ...
            if (dataIndex < dataLength) {
              ...
              rowArr.push( /*#__PURE__*/_react["default"].createElement(_index2["default"].Item, {
                key: j,
          ...
          rowsArr.push( /*#__PURE__*/_react["default"].createElement(_index2["default"], {
            key: i,
        ...
        if (isCarousel && pageCount > 1) {
          for (var pageIndex = 0; pageIndex < pageCount; pageIndex++) {
            ...
            for (var ii = 0; ii < carouselMaxRow; ii++) {
              ...
              if (rowIndex < rowCount) {
                ...
                for (var jjj = 0; jjj < columnNum; jjj++) {
                  res.push( /*#__PURE__*/_react["default"].createElement(_index2["default"].Item, {
                    key: jjj,
                    style: [styles.grayBorderBox, flexItemStyle]
                  }));
                }

                pageRows.push( /*#__PURE__*/_react["default"].createElement(_index2["default"], {
                  key: rowIndex,
            ...
            pagesArr.push( /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
              key: pageIndex,
              style: [styles.grayBorderBox, {
        ...
        return isCarousel && pageCount > 1 ? /*#__PURE__*/_react["default"].createElement(_index["default"], (0, _extends2["default"])({
          infinite: false,
          dots: true
        }, carouselProps), pagesArr) : /*#__PURE__*/_react["default"].createElement(_index2["default"], {
          direction: "column"
        }, rowsArr);
      });
    }

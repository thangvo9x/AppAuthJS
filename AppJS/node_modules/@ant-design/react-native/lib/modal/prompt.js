...
var _PromptContainer = _interopRequireDefault(require("./PromptContainer"));
...
function prompt(title, message, callbackOrActions) {
  ...
  var onBackHandler = arguments.length > 6 ? arguments[6] : undefined;
  ...
  var key = _portal["default"].add( /*#__PURE__*/_react["default"].createElement(_PromptContainer["default"], {
    title: title,
    message: message,
